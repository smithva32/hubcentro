...
<nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
    ...
    <div class="menu-logo">
        <div class="navbar-brand">
            <span class="navbar-logo">
                     ...
                     <img src="{{ asset('assets/images/logo.jpg') }}" alt="Mobirise" title="HOLA PAPA" style="height: 3.8rem;">
    ...
    <form class="form-inline" action="{{ url('/buscador') }}" method="GET">
                @csrf
                <input style="height: 0px" class="form-control input-sm mr-sm-2" name="busqueda" type="text" placeholder="Busqueda" aria-label="Search">
