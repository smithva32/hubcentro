...
<div style="margin-top: 140px; margin-bottom: 180px;" class="container">
    ...
    <div style="margin-top: 5px; margin-bottom: 20px; text-align:center;">
        ...
        <button style="margin-left: 450px; border-radius: 40px" onclick="location='{{ url('/admin/articulos') }}'" type="submit" class="btn btn-primary btn-sm">Ver Todos</button> 
    </div>
    <div style="margin-top: 20px; margin-left: 35%;">
        <form class="form-inline" action="{{url('admin/buscador/articulos')}}" method="GET">
            @csrf
            <div class="form-group">
            <input style="border-radius: 40px; text-align:center;" type="text" class="form-control" id="exampleInputEmail2" name="busqueda" placeholder="Buscar por tema o tena">
            </div>
	...
	<div class="row" style="margin-top: 20px; margin-bottom: 25px;">
        <strong>Nuemero de articulos: {{ $articulos->count() }} </strong>
    </div>
