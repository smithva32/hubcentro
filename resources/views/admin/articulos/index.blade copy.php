...
<div style="margin-top: 140px; margin-bottom: 180px;" class="container">
    <div style="margin-top: 5px; margin-bottom: 20px; text-align:center;">
        <button type="button" style="border-radius: 40px"  class="btn-personalizado btn-sm"><a href="{{ route('articulos.create') }}">Añadir Artículo</a></button>
	    <button id="eliminar" style="margin-left: 450px; border-radius: 40px" type="submit" onclick="return confirm('¿Estás Seguro de eliminar todos lor articulos?')" class="btn btn-secondary btn-sm">Eliminar Todo</button>
    </div>
    ...
    <div style="margin-top: 20px; margin-left: 35%;">
        <form class="form-inline" action="{{url('admin/buscador/articulos')}}" method="GET">
            ...
            <input style="border-radius: 40px; text-align:center;" type="text" class="form-control" id="exampleInputEmail2" name="busqueda" placeholder="Buscar por tema o usuario">
            </div>
            <button style="margin-top: 8px; border-radius: 40px" type="submit" class="btn btn-primary btn-sm">Buscar</button>
        </form>
