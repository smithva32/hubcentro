	    ...
	    <div class="row">
	        ...
	        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
				...
				@foreach($articulo->imagenes as $imagen)
					<div class="padre" id="{{ $imagen->id }}" style="float:left;">
						...
						<a href="{{ route('imagen.delete',$imagen) }}">
							<img class="hijo" style="cursor:pointer; margin-left: -5px; margin-top: -200px" width="20px" src="{{asset('imagenes/admin/eliminar.png')}}">
						</a>
					</div>
				@endforeach
				...
				<div style="margin-top: 35px; margin-bottom: 20px; text-align:center;">
					...
					<button style="border-radius: 40px" type="button" class="btn btn-secondary"><a href="{{ url('/admin/articulos') }}">Cancelar</a></button>
				</div>
			</div>
	    </div>
	</div>
